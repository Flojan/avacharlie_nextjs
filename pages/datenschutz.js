...
export default function Datenschutz() {
  return (
    <div className="flex justify-center ml-7 mr-7 overflow-x-hidden">
      <div className="text-ava mt-20 mb-20 flex flex-col w-full max-w-screen-md">
        <h1 id="privacy" className="text-4xl mb-4">
          Datenschutzerklärung
        </h1>
        <h2 className="text-3xl mb-2 mt-6">Einleitung</h2>
        <p>
        ...
        <p>Stand: 11. Oktober 2021</p>
        <h2 className="text-3xl mb-2 mt-6">Inhaltsübersicht</h2>
        <ul className="index">
          <li>
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m3">
          Verantwortlicher
        </h2>
        <p>
          Ava Charlie
          ...
          Frau Nathalie Hoyer
          <br />
          {/* Neue Schmiedgasse 24<br />
        55283 Nierstein */}
        </p>
        <p>
          E-Mail-Adresse:
          <a href="mailto:avacharliemusic@gmail.com">
            avacharliemusic@gmail.com
          </a>
          .
        </p>
        <p>
          Impressum:
          <a
            href="https://avacharlie.de/impressum"
            target="_blank"
            rel="noreferrer"
          >
            https://avacharlie.de/impressum
          </a>
          .
        </p>
        <h2 className="text-3xl mb-2 mt-6" id="mOverview">
          Übersicht der Verarbeitungen
        </h2>
        <p>
        ...
        <h3 className="text-2xl mb-2 mt-6">Arten der verarbeiteten Daten</h3>
        <ul>
        ...
        <h3 className="text-2xl mb-2 mt-6">Kategorien betroffener Personen</h3>
        <ul>
          <li>Kommunikationspartner.</li>
          <li>Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten).</li>
        </ul>
        <h3 className="text-2xl mb-2 mt-6">Zwecke der Verarbeitung</h3>
        <ul>
          <li>
        ...
        <h3 className="text-2xl mb-2 mt-6" id="m13">
          Maßgebliche Rechtsgrundlagen
        </h3>
        <p>
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m27">
          Sicherheitsmaßnahmen
        </h2>
        <p>
        ...
        <p>
          <strong>Kürzung der IP-Adresse</strong>: Sofern IP-Adressen von uns
          oder von den eingesetzten Dienstleistern und Technologien verarbeitet
          werden und die Verarbeitung einer vollständigen IP-Adresse nicht
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m25">
          Übermittlung von personenbezogenen Daten
        </h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m24">
          Datenverarbeitung in Drittländern
        </h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m12">
          Löschung von Daten
        </h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m134">
          Einsatz von Cookies
        </h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m225">
          Bereitstellung des Onlineangebotes und Webhosting
        </h2>
        <p>
        ...
        <ul className="m-elements">
          <li>
            <strong>IONOS by 1&1:</strong> Hostingplattform für E-Commerce /
            Websites; Dienstanbieter: 1&1 IONOS SE, Elgendorfer Str. 57, 56410
            Montabaur, Deutschland; Website:
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m296">
          Musik und Podcasts
        </h2>
        <p>
          Wir nutzen Hosting- und Analyse-Angebote von Dienstanbieter, um unsere
          Audio-Inhalte zum Anhören bzw. zum Download anzubieten und
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m136">
          Präsenzen in sozialen Netzwerken (Social Media)
        </h2>
        <p>
        ...
        <p>
          <strong>Facebook</strong>: Wir sind gemeinsam mit Facebook Irland Ltd.
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m328">
          Plugins und eingebettete Funktionen sowie Inhalte
        </h2>
        <p>
        ...
        <ul className="m-elements">
          <li>
            <strong>Typekit-Schriftarten von Adobe:</strong> Wir binden die
            Schriftarten ("Typekit fonts") des Anbieters Adobe ein, wobei die
            Daten der Nutzer allein zu Zwecken der Darstellung der Schriftarten
            ...
            deren einheitlicher Darstellung sowie unter Berücksichtigung
            möglicher lizenzrechtlicher Restriktionen für deren Einbindung.
            Dienstanbieter: Adobe Systems Software Ireland Limited, 4-6
            Riverwalk, Citywest Business Campus, Dublin 24, Irland; Website:
            <a href="https://www.adobe.com/de" target="_blank" rel="noreferrer">
          ...
          <li>
            <strong>YouTube-Videos:</strong> Videoinhalte; Dienstanbieter:
          ...
          <li>
            <strong>YouTube-Videos:</strong> Videoinhalte; YouTube-Videos werden
            über eine spezielle Domain (erkennbar an dem Bestandteil
            "youtube-nocookie") im sogenannten "Erweiterten Datenschutzmodus"
            eingebunden, wodurch keine Cookies zu Nutzeraktivitäten erhoben
            werden, um die Videowiedergabe zu personalisieren. Dennoch können
            Angaben zur Interaktion der Nutzer mit dem Video (z.B. Merken der
            letzten Wiedergabestelle), gespeichert werden; Dienstanbieter:
            Google Ireland Limited, Gordon House, Barrow Street, Dublin 4,
            Irland, Mutterunternehmen: Google LLC, 1600 Amphitheatre Parkway,
            Mountain View, CA 94043, USA; Website:
            <a href="https://www.youtube.com" target="_blank" rel="noreferrer">
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m15">
          Änderung und Aktualisierung der Datenschutzerklärung
        </h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m10">
          Rechte der betroffenen Personen
        </h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 mt-6" id="m42">
          Begriffsdefinitionen
        </h2>
        <p>
        ...
        <ul className="glossary">
          <li>
            ...
            dem die Wirksamkeit von Marketingmaßnahmen festgestellt werden kann.
